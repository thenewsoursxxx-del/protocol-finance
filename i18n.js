...
(function (global) {
  ...
  var I18N = {
    ru: {
      ...
      "portfolio.savingsMode.title": "Учёт накоплений",
      "portfolio.savingsMode.current": "Только текущая сумма",
      "portfolio.savingsMode.future": "С будущими отложениями",
      "portfolio.savingsMode.currentHint": "Расчёт идёт от того, что уже накоплено",
      "portfolio.savingsMode.futureHint": "Учитываем будущие пополнения по тому же распределению",
    ...
    en: {
      ...
      "portfolio.edit": "Edit",
      "portfolio.savingsMode.title": "Savings model",
      "portfolio.savingsMode.current": "Current balance only",
      "portfolio.savingsMode.future": "Include future top-ups",
      "portfolio.savingsMode.currentHint": "Calculation uses only what you've already saved",
      "portfolio.savingsMode.futureHint": "Future top-ups follow the same allocation",
